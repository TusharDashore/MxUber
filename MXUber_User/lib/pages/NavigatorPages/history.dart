          ...
          children: [
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          MyText(
                                                                              text: myHistory[i]['vehicle_type_name'].toString(),
                                                                              fontweight: FontWeight.w600,
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              MyText(
                                                                                  text: (myHistory[i]['is_bid_ride'] == 1)
                                                                                      ? '${myHistory[i]['requested_currency_symbol']} ${myHistory[i]['accepted_ride_fare'].toString()}'
            ...
            (showFilter)
                ? Positioned(
                    ...
                    top:
                        MediaQuery.of(context).padding.top + media.width * 0.12,
                    child: Material(
                      elevation: 10,
