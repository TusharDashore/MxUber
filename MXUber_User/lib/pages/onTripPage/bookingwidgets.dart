          ...
          children: [
            Padding(
              ...
              child: MyText(
                ...
                text:
                    '${languages[choosenLanguage]['text_apply']} ${languages[choosenLanguage]['text_coupons']}',
                          ...
                          children: [
                            ...
                            (rentalOption[widget.showInfoInt]['has_discount'] !=
                                ...
                                ? Row(
                                    ...
                                    children: [
                                      Text(
                                        '${rentalOption[widget.showInfoInt]['currency']} ${rentalOption[widget.showInfoInt]['fare_amount'].toStringAsFixed(2)}',
                                        style: GoogleFonts.notoSans(
                                            fontSize: media.width * fourteen,
                                            color: textColor,
                                            fontWeight: FontWeight.w600),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 6,
                                          child: MyText(
                                            text: etaDetails[choosenVehicle]['payment_type']
                                                .toString()
                                                .split(',')
                                                .toList()[i]
                                                .trim()
